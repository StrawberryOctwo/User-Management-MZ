...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      dividerBg: '#2C2C2C',
      menuItemColor: '#A0A0A0',
      menuItemColorActive: themeColors.primary,
      menuItemBg: themeColors.surface,
      menuItemBgActive: '#2C2C2C',
...
export const DarkTheme = createTheme({
  ...
  palette: {
    ...
    text: {
      ...
      disabled: alpha(themeColors.textPrimary, 0.5),
    },
    action: {
      active: themeColors.textPrimary,
      hover: alpha(themeColors.textPrimary, 0.08),
      hoverOpacity: 0.08,
      selected: alpha(themeColors.textPrimary, 0.16),
      selectedOpacity: 0.16,
      disabled: alpha(themeColors.textPrimary, 0.3),
      disabledBackground: alpha(themeColors.textPrimary, 0.12),
      disabledOpacity: 0.38,
      focus: alpha(themeColors.textPrimary, 0.12),
      focusOpacity: 0.12,
