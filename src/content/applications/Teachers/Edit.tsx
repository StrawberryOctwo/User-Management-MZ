...
const EditTeacher = () => {
  ...
  const [teacherData, setTeacherData] = useState<Record<string, any> | null>(
    null
  );
  ...
  const fetchTeacher = async () => {
    ...
    try {
      ...
      const formattedDocuments = teacherDocuments.documents.map(
        (doc: { id: any; name: any; type: any; path: any }) => ({
          id: doc.id,
          fileName: doc.name,
          fileType: doc.type,
          file: null,
