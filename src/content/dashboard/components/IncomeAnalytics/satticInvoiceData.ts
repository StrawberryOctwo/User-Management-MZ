...
export const staticInvoiceData: InvoiceData = {
  ...
  month: {
    income: [5000, 6000, 5500, 7000, 6500, 8000, 7500, 8200, 9000, 8500, 9300, 10000],
    expense: [3000, 3500, 3200, 4000, 3800, 4500, 4200, 4800, 5000, 4700, 5200, 5500],
    netIncome: [2000, 2500, 2300, 3000, 2700, 3500, 3300, 3400, 4000, 3800, 4100, 4500],
