...
function TrafficSources() {
  ...
  const chartOptions = {
    stroke: {
      curve: 'smooth' as 'smooth', // Ensures TypeScript knows it's a valid literal
      width: [0, 5]
    },
    theme: {
      mode: theme.palette.mode as 'light' | 'dark' // Ensures it's a valid literal
    },
    chart: {
    ...
    markers: {
      ...
      shape: 'circle' as 'circle', // Valid marker shape type
      size: 6,
      strokeWidth: 3,
      strokeOpacity: 1,
